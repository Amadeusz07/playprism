...
namespace Playprism.Services.TournamentService.DAL.Migrations
{
    ...
    [Migration("20210106175033_MatchDefinitionsChanges")]
    partial class MatchDefinitionsChanges
    {
            ...
            modelBuilder.Entity("Playprism.Services.TournamentService.DAL.Entities.RoundEntity", b =>
                {
                    ...
                    b.HasOne("Playprism.Services.TournamentService.DAL.Entities.RoundEntity", "NextRound")
                        .WithMany()
                        .HasForeignKey("NextRoundId");

                    b.HasOne("Playprism.Services.TournamentService.DAL.Entities.RoundEntity", "PreviousRound")
                        .WithMany()
